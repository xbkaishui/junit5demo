package com.xbkaishui.bookstoread.resolver;
...
/**
 * Resolve book test case parameters
 */
public final class BooksParameterResolver implements ParameterResolver {

    @Override
    public boolean supportsParameter(ParameterContext parameterContext, ExtensionContext extensionContext) throws ParameterResolutionException {
        Parameter parameter = parameterContext.getParameter();
        String typeName = parameter.getParameterizedType().getTypeName();
        return Objects.equals(typeName, "java.util.Map<java.lang.String, com.xbkaishui.bookstoread.Book>");
    }
